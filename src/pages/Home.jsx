...
const CITY_TO_COUNTY = {
  ...
  // Riverside County, CA — DEH Facility Records Portal (live HTML scrape)
  "perris": { region: "california", countyId: "riverside", locationLabel: "Perris, CA" },
  "riverside ca": { region: "california", countyId: "riverside", locationLabel: "Riverside, CA" },
  "riverside": { region: "california", countyId: "riverside", locationLabel: "Riverside, CA" },
  "moreno valley": { region: "california", countyId: "riverside", locationLabel: "Moreno Valley, CA" },
  "corona ca": { region: "california", countyId: "riverside", locationLabel: "Corona, CA" },
  "murrieta": { region: "california", countyId: "riverside", locationLabel: "Murrieta, CA" },
  "temecula": { region: "california", countyId: "riverside", locationLabel: "Temecula, CA" },
  "palm springs": { region: "california", countyId: "riverside", locationLabel: "Palm Springs, CA" },
  "palm desert": { region: "california", countyId: "riverside", locationLabel: "Palm Desert, CA" },
  "indio": { region: "california", countyId: "riverside", locationLabel: "Indio, CA" },
  "coachella": { region: "california", countyId: "riverside", locationLabel: "Coachella, CA" },
  "cathedral city": { region: "california", countyId: "riverside", locationLabel: "Cathedral City, CA" },
  "la quinta": { region: "california", countyId: "riverside", locationLabel: "La Quinta, CA" },
  "rancho mirage": { region: "california", countyId: "riverside", locationLabel: "Rancho Mirage, CA" },
  "indian wells": { region: "california", countyId: "riverside", locationLabel: "Indian Wells, CA" },
  "desert hot springs": { region: "california", countyId: "riverside", locationLabel: "Desert Hot Springs, CA" },
  "hemet": { region: "california", countyId: "riverside", locationLabel: "Hemet, CA" },
  "san jacinto": { region: "california", countyId: "riverside", locationLabel: "San Jacinto, CA" },
  "menifee": { region: "california", countyId: "riverside", locationLabel: "Menifee, CA" },
  "lake elsinore": { region: "california", countyId: "riverside", locationLabel: "Lake Elsinore, CA" },
  "wildomar": { region: "california", countyId: "riverside", locationLabel: "Wildomar, CA" },
  "norco": { region: "california", countyId: "riverside", locationLabel: "Norco, CA" },
  "eastvale": { region: "california", countyId: "riverside", locationLabel: "Eastvale, CA" },
  "jurupa valley": { region: "california", countyId: "riverside", locationLabel: "Jurupa Valley, CA" },
  "beaumont ca": { region: "california", countyId: "riverside", locationLabel: "Beaumont, CA" },
  "banning": { region: "california", countyId: "riverside", locationLabel: "Banning, CA" },
  ...
  // San Diego County, CA — live SDFoodInfo (DEH) portal
  "san diego": { region: "california", countyId: "san_diego", locationLabel: "San Diego, CA" },
  "san diego county": { region: "california", countyId: "san_diego", locationLabel: "San Diego County, CA" },
  "la jolla": { region: "california", countyId: "san_diego", locationLabel: "La Jolla, CA" },
  "gaslamp": { region: "california", countyId: "san_diego", locationLabel: "San Diego, CA" },
  "pacific beach": { region: "california", countyId: "san_diego", locationLabel: "Pacific Beach, CA" },
  "mission beach": { region: "california", countyId: "san_diego", locationLabel: "San Diego, CA" },
  "north park": { region: "california", countyId: "san_diego", locationLabel: "San Diego, CA" },
  "little italy san diego": { region: "california", countyId: "san_diego", locationLabel: "San Diego, CA" },
  "hillcrest": { region: "california", countyId: "san_diego", locationLabel: "San Diego, CA" },
  "chula vista": { region: "california", countyId: "san_diego", locationLabel: "Chula Vista, CA" },
  "el cajon": { region: "california", countyId: "san_diego", locationLabel: "El Cajon, CA" },
  "escondido": { region: "california", countyId: "san_diego", locationLabel: "Escondido, CA" },
  "carlsbad": { region: "california", countyId: "san_diego", locationLabel: "Carlsbad, CA" },
  "oceanside": { region: "california", countyId: "san_diego", locationLabel: "Oceanside, CA" },
  "encinitas": { region: "california", countyId: "san_diego", locationLabel: "Encinitas, CA" },
  "national city": { region: "california", countyId: "san_diego", locationLabel: "National City, CA" },
  "imperial beach": { region: "california", countyId: "san_diego", locationLabel: "Imperial Beach, CA" },
  "la mesa": { region: "california", countyId: "san_diego", locationLabel: "La Mesa, CA" },
  "lemon grove": { region: "california", countyId: "san_diego", locationLabel: "Lemon Grove, CA" },
  "santee": { region: "california", countyId: "san_diego", locationLabel: "Santee, CA" },
  "poway": { region: "california", countyId: "san_diego", locationLabel: "Poway, CA" },
  "san marcos": { region: "california", countyId: "san_diego", locationLabel: "San Marcos, CA" },
  "vista ca": { region: "california", countyId: "san_diego", locationLabel: "Vista, CA" },
  "fallbrook": { region: "california", countyId: "san_diego", locationLabel: "Fallbrook, CA" },
  "del mar": { region: "california", countyId: "san_diego", locationLabel: "Del Mar, CA" },
  "coronado": { region: "california", countyId: "san_diego", locationLabel: "Coronado, CA" },
  ...
  "juneau": { region: "alaska", countyId: "juneau", locationLabel: "Juneau, AK" },
  "wasilla": { region: "alaska", countyId: "wasilla", locationLabel: "Wasilla, AK" },
  "ketchikan": { region: "alaska", countyId: "ketchikan", locationLabel: "Ketchikan, AK" },
  "sitka": { region: "alaska", countyId: "sitka", locationLabel: "Sitka, AK" },
  "kenai": { region: "alaska", countyId: "kenai", locationLabel: "Kenai, AK" },
  "soldotna": { region: "alaska", countyId: "soldotna", locationLabel: "Soldotna, AK" },
  "kodiak": { region: "alaska", countyId: "kodiak", locationLabel: "Kodiak, AK" },
  "bethel ak": { region: "alaska", countyId: "bethel", locationLabel: "Bethel, AK" },
  "palmer": { region: "alaska", countyId: "wasilla", locationLabel: "Palmer, AK" },
  "homer": { region: "alaska", countyId: "kenai", locationLabel: "Homer, AK" },
  "nome": { region: "alaska", countyId: "nome", locationLabel: "Nome, AK" },
  "barrow": { region: "alaska", countyId: "barrow", locationLabel: "Utqiagvik, AK" },
  "utqiagvik": { region: "alaska", countyId: "barrow", locationLabel: "Utqiagvik, AK" },
  "valdez": { region: "alaska", countyId: "valdez", locationLabel: "Valdez, AK" },
  "alaska": { region: "alaska", countyId: "anchorage", locationLabel: "Alaska" },
...
const LIVE_API_CITIES = [
  ...
  { label: "San Diego, CA", region: "california", countyId: "san_diego", emoji: "🌊", example: "tacos", locationLabel: "San Diego, CA" },
];
