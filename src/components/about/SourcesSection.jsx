...
const METHODS = [
  { icon: <Database className="w-5 h-5 text-white" />, bg: "bg-emerald-600", title: "Live Government APIs", pill: { text: "REAL-TIME", color: "bg-emerald-500 text-white" }, body: "For jurisdictions that publish open-data APIs — including New York City, Chicago, San Francisco, King County (Seattle), Austin, Montgomery County MD, Delaware, New York State, and Dubai Municipality via Dubai Pulse — SafeEats queries the official database directly at request time. Data is current as of the moment you search." },
  { icon: <Search className="w-5 h-5 text-white" />, bg: "bg-slate-900", title: "AI-Assisted Research", pill: { text: "EVERYWHERE ELSE", color: "bg-slate-500 text-white" }, body: "For jurisdictions without a live API, our AI reads official health department websites, publicly posted inspection PDFs, and verified local news. Preliminary results are powered by GPT-5 Mini for fast restaurant identification, while live web search uses Gemini 3 Flash to pull real-time inspection data from official sources. Results are clearly labeled as AI-estimated — never presented as official government data." },
