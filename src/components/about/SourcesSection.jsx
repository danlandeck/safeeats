...
const METHODS = [
  { icon: <Database className="w-5 h-5 text-white" />, bg: "bg-emerald-600", title: "Live Government APIs", pill: { text: "REAL-TIME", color: "bg-emerald-500 text-white" }, body: "For jurisdictions that publish open-data APIs — including New York City, New York State, San Francisco, Chicago, King County (Seattle), Austin, Dallas County, Montgomery County MD, Delaware, Boston, Houston, Los Angeles County, Wake County (Raleigh, NC), Louisville KY, Las Vegas (SNHD), Toronto (Canada), Vancouver (Canada), the UK Food Standards Agency, France (Alim'confiance / DGCCRF), and the Netherlands (NVWA) — SafeEats queries the official database directly at request time. Data is current as of the moment you search." },
