...
export default function EPAWaterCard({ city, source, zip_code }) {
  ...
  // Need at least a zip code or city to link to EWG
  if (!zip_code && !city) return null;

  // EWG URL — zip code search is most accurate, city name is fallback
  ...
  return (
    ...
    >
      ...
      <a
        ...
        aria-label={`Check tap water quality for zip code ${zip_code || city} on EWG (opens in new tab)`}
      >
