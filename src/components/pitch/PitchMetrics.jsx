...
const METRICS = [
  { icon: Database, value: "23+", label: "Live data sources", sub: "Direct government APIs" },
  { icon: Globe, value: "5", label: "Live API countries", sub: "US, UK, Canada, France, Netherlands" },
