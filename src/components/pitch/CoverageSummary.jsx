...
const TIERS = [
  ...
  },
  {
    ...
    body: "Markets where public data exists in some form but no API connector is built yet — Japan, Germany, Brazil, India, Hong Kong, and more. Each is a roadmap milestone with a clear integration path.",
