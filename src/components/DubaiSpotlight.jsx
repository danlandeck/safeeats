    ...
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0a1628] via-[#0d2240] to-[#1a3a2a] border border-[#c9a227]/30 shadow-2xl">
      ...
      <div className="px-5 pt-5 pb-4">
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5 leading-relaxed">
              Dubai Municipality inspects every licensed establishment. We publish it all.
            </p>
          </div>
        ...
        <p className="text-[10px] text-slate-600 mt-3 text-center">
          Data sourced via Dubai Municipality / Dubai Pulse open data portal · Scores normalized to A–F scale
        </p>
      </div>
    </div>
  );
