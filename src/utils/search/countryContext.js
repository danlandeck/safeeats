...
export const COUNTRY_CONTEXT = {
  ...
  kentucky: "Kentucky food safety inspections are managed by local health departments (no state-wide portal). Lexington/Fayette County (lfchd.org), Lake Cumberland District (lcdhd.org), Lincoln Trail District (ltdhd.org) publish scores. 85+ with no critical violations = passing score. AI web search required for inspection scores outside Louisville Metro.",
  louisiana: "Louisiana Department of Health (LDH) — retail food inspections for ~32,000 establishments. Uses critical and non-critical violation categories. Baton Rouge/East Baton Rouge Parish data available via Socrata open data (data.brla.gov). Other parishes use the 'Eat Safe Louisiana' dashboard (ldh.la.gov) — AI web search required.",
  mississippi: "Mississippi State Department of Health (MSDH) — state-wide portal at apps.msdh.ms.gov/food covering ALL 82 counties. A/B/C grading: A=90+, B=80-89, C=70-79. Uses FDA Food Code inspection checklist with compliance statuses. Inspections 1-4 times per year based on risk. Public portal at apps.msdh.ms.gov/food — search by facility name and city.",
  maine: "Maine Center for Disease Control & Prevention (Maine CDC) — Health Inspection Program at apps.web.maine.gov/online/hip_search. State-wide coverage for all 16 counties. Uses Maine Food Code (based on FDA Food Code). Critical and non-critical violations; failed if >3 critical or >10 non-critical. Biennial inspections. Portal protected by reCAPTCHA — AI web search required.",
  michigan: "Michigan restaurant inspections are managed by 45 local health departments (no state-wide restaurant portal). MDARD covers grocery/convenience stores only. Detroit has open data (ArcGIS Hub). Other counties use various local portals — AI web search required.",
  minnesota: "Minnesota Department of Health (MDH) — food inspections managed by MDH and local public health agencies. No state-wide restaurant inspection search portal available. AI web search required for inspection scores.",
  missouri: "Missouri Department of Health and Senior Services (DHSS) — food inspections managed by local public health agencies. No state-wide restaurant inspection search portal. AI web search required for inspection scores.",
  montana: "Montana Department of Public Health and Human Services (DPHHS) — Environmental Health and Food Safety Section. Uses 2013 Food Code. No state-wide restaurant inspection search portal. AI web search required for inspection scores.",
  nebraska: "Nebraska DHHS — food inspections managed by local health departments. Lincoln-Lancaster County Health Department (LLCHD) has an inspection viewer. Douglas County (Omaha) has an ArcGIS restaurant ratings app. No state-wide restaurant inspection search portal — AI web search required.",
  nevada_reno: "Washoe County (Reno) — Northern Nevada Public Health (NNPH) at nnph.org. Pass/Conditional Pass/Fail/Closed grading. Portal behind Cloudflare — AI web search required.",
  new_hampshire: "NH DHHS Food Protection — state-wide Salesforce portal (nh-dhhs.my.site.com/fsre). Green/Yellow/Red color rating. ~5,000 establishments. 15 self-inspecting communities excluded. Portal is JS SPA — AI web search required.",
  new_jersey: "NJ restaurant inspections by local county/city health departments (no state-wide portal). NJ DOH PHFPP oversees rules only. Camden, Gloucester, Ocean, Middlesex, Hunterdon counties have online portals. Newark has city portal. AI web search required.",
  new_mexico: "NM Environment Department (NMED) Food Safety Program — no state-wide search portal. Albuquerque has Socrata Connect portal (JS-rendered). Green/Yellow/Red/Orange sticker system. AI web search required.",
  north_dakota: "ND HHS Food and Lodging Unit — state-wide ASP.NET portal at fims.doh.nd.gov. Inspection reports as PDFs. FDA Food Code Priority/Priority Foundation/Core violations. AI web search required.",
  ohio: "OH restaurant inspections by local health departments (no state-wide portal). ODH Food Safety Program oversees rules. Franklin County uses Accela. Cincinnati, Summit, Cuyahoga have local portals. AI web search required.",
  oklahoma: "OK State Department of Health (OSDH) — state-wide portal at phin.state.ok.us covering all 77 counties. No letter grades — violations listed per inspection. FDA Food Code categories. Backend scraper provides real violation data.",
  ...
  portland_oregonlive: "Portland area (Multnomah & Clackamas counties, OR) — restaurant inspection data from OregonLive database (restaurants.oregonlive.com/inspections). Real numeric 0-100 scores from county health department inspections. NOTE: This is historical data frozen at 2019-2020. For current inspection data, link to the official Multnomah County portal at inspections.myhealthdepartment.com/multco-eh. Oregon uses FDA Food Code with Priority (P), Priority Foundation (Pf), and Core (C) violation categories. 100-point scale: P/Pf violations deducted from 100. Semiannual inspections twice per year. Score 70+ = pass, below 70 = reinspection required.",
