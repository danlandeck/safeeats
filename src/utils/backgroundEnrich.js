...
const ENRICH_CONTEXT = {
  ...
  wyoming: "Wyoming Department of Agriculture (WDA) Consumer Health Services — state-wide portal at wda.safefoodinspection.com. Covers all establishments inspected by WDA (areas without local health departments). Routine inspections only. Uses IN/OUT/COS/NC/C compliance coding per FDA Food Code. AI web search required for inspection scores.",
