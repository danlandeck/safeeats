...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/data-audit" element={<LayoutWrapper currentPageName="DataIntegrityAudit"><DataIntegrityAudit /></LayoutWrapper>} />
...
function App() {
  // Sync dark mode with system preference (prefers-color-scheme)
  useEffect(() => {
