...
const US_STATE_INFO: Record<string, {dept:string;rating:string;scale:string;ctx:string}> = {
  ...
  OR: { dept:"OR county health depts (OHA)", rating:"100-point (70=pass)", scale:"0-100 numeric", ctx:"Oregon: OHA (oregon.gov/oha/ph/healthyenvironments/foodsafety). County health depts — Multnomah, Clatsop, Lane, Marion, Washington, Deschutes, Jackson, Clackamas. Most Oregon counties publish inspection results on HealthSpace portal (inspections.myhealthdepartment.com). Statewide portal available. Inspections 1-2 times/year." },
